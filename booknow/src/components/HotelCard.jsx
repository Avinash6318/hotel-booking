...
const HotelCard = ({room,index}) => {
  return (
    <Link className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white
     text-gray-500/90 shadow-[10px_4px_4px_rgba(0,0,0,0.05)]'
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex items-center gap-1 text-sm'>
                    ...
                    <div className='dlex items-center justify-between mt-4'>
                        ...
                        hover:bg-gray-50 transition-all cursor-pointer'>BOOKNOW</button>
                    </div>
                </div>
            </div>
        </div>
