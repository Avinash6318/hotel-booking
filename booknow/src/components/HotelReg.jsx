...
const HotelReg = () => {
  ...
  return (
    <div onClick={()=> setShowHotelReg(false)} className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70 '>
        <form onSubmit={submitHandler} onClick={(e)=> e.stopPropagation()} className="flex bg-white rounded-xl max-w-4xl max-md:mx-2">
            ...
            <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
             ...
             src={assets.closeIcon} alt="closeIcon" className="absolute top-4 right-4 h-4 w-4 cursor-pointer" />
             ...
             <div className="w-full mt-4">
                ...
                <input id='name' onChange={(e)=> setName(e.target.value)} value={name} type="text" className="border border-blue-600 rounded w-full 
             ...
             <div className="w-full mt-4">
                ...
                <input id='contact' onChange={(e)=> setContact(e.target.value)} value={contact} type="text" className="border border-blue-600 rounded w-full 
                px-3 py-2 5 mt-1 outline-indigo-500 font-light" required/>
             </div>
             ...
             <div className="w-full mt-4">
                ...
                <input id='address' onChange={(e)=> setAddress(e.target.value)} value={address} type="text" className="border border-blue-600 rounded w-full 
                px-3 py-2 5 mt-1 outline-indigo-500 font-light" required/>
             </div>
             ...
             <div className="w-full mt-4 max-w-60 mr-auto">
                ...
                <select  id="city" onChange={(e)=> setCity(e.target.value)} value={city} className="border border-blue-500 rounded w-full 
                px-3 py-2.5 mt-1 outline-indigo-500 font-light " required>
