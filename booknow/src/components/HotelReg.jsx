        ...
        <form  className="flex bg-white rounded-xl max-w-4xl max-md:mx-2">
            ...
            <div className="relative flex flex-col items-center md:w-1/2 p-8 md:p-10">
             ...
             <div className="w-full mt-4">
                ...
                <input id='name' type="text" className="border border-blue-600 rounded w-full 
             ...
             <div className="w-full mt-4">
                ...
                <input id='contact' type="text" className="border border-blue-600 rounded w-full 
                px-3 py-2 5 mt-1 outline-indigo-500 font-light" required/>
             </div>
             ...
             <div className="w-full mt-4">
                ...
                <input id='address' type="text" className="border border-blue-600 rounded w-full 
                px-3 py-2 5 mt-1 outline-indigo-500 font-light" required/>
             </div>
             ...
             <div className="w-full mt-4 max-w-60 mr-auto">
                ...
                <select  id="city" className="border border-blue-500 rounded w-full 
                px-3 py-2.5 mt-1 outline-indigo-500 font-light " required>
