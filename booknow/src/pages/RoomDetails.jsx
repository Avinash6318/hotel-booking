...
const RoomDetails = () => {
    ...
    const checkAvailability = async () => {
      try {
        ...
        const {data} = await axios.post('/api/bookings/check-availability', {room : 1, checkInDate, checkOutDate})
        if(data.success){
          if(data.isAvailable){
            setIsAvailable(true)
    ...
    //onSumbitHandler funtion to check availability & book the room
  ...
  return room&& (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className="flex flex-col lg:flex-row mt-6 gap-6">
        ...
        <img src={mainImage} alt="roomImage" className="w-full rounded-xl shadow-lg object-cover" /></div>
      ...
      <div className="flex flex-col md:flex-row md:justify-between mt-10">
        <div className="flex flex-col">
          <h1 className='text-3xl md:text-4xl font-playfair'> 
            Experience your trip like a king. for all normal trips to make a premium trip 
          </h1>
      ...
      className="flex flex-col md:flex-row items-start md:items-cenetr justify-between
       bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
          <div className="flex flex-col">
            <label htmlFor="checkInDate" className='font-medium'>checkInDate</label>
          ...
          <div className="w-px h-15 bg-gray-300/70 max-md:hdden"></div>
        ...
        <button type='submit' className="bg-blue-800 hover:bg-blue-600 hover:text-black active:scale-95 transition-all text-white
      ...
      <div className="max-w-4xl border-y border-gray-300 my-15 py-10 text-gray-500">
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Est ad quisquam
           corporis officiis eveniet perspiciatis, illum asperiores, ut animi ipsum 
           inventore odio esse aspernatur obcaecati quasi sed deserunt molestiae maiores?</p>
      </div>
      ...
      <div className="flex flex-col items-start gap-4">
        ...
        <button className="px-6 py-2 5 mt-4 rounded text-white bg-blue-700
         hover:bg-blue-400 hover:text-black transition-all cursor-pointer">
          Contact Now
         </button>
      </div>
    </div>
